...
<div class="page-wrapper">
    ...
    <div class="area-admin-form">
        ...
        <div class="card-body">
            ...
            <div class="column">
                <form method="post" action="{{ route('users.area_admin.update', $area_admin->id) }}">
                    @csrf
                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control area_name" name="area_name" value="{{ $area_admin->area_name }}">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control area_admin_name" name="area_admin_name" value="{{ $area_admin->area_admin_name }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control area_admin_email" name="area_admin_email" value="{{ $area_admin->email }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="password" class="form-control area_admin_password" name="area_admin_password" value="{{ $area_admin->password }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control area_admin_user_name" name="area_admin_user_name" value="{{ $area_admin->name }}">
                                        <div class="form-text text-muted">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class="form-control area_admin_phone" name="area_admin_phone" value="{{ $area_admin->area_admin_phone }}">
                                        <div class="form-text text-muted">
