...
<section id="wrapper">
    <div class="login-register" style="background-color:#29357d;">
        <div class="login-logo text-center py-3">
            <a href="#" style="display: inline-block;background: #fff;padding: 10px;border-radius: 5px;"><img src="{{ asset('images/logo_web.png') }}" style="width: 180px;"> </a>
        </div>
                    ...
                    <div class="form-group text-center m-t-20 mb-0">
                        <div class="col-xs-12">
                            <button type="submit"
                                    ...
                                    style="background-color:#29357d;">
                                {{ __('Login') }}
                            </button>
                            <?php if(env('IS_DISABLE_DELETE', 0)){ ?>
                            <div class="form-group default-admin">
                                <div class="crediantials-field">Email:<span id="email_field">admin@foodie.com</span><a
                                        href="javascript:void(0)" onclick="copyToClipboard('admin@foodie.com')"><i class="fa fa-copy"></i></a>
                                </div>
                                <div class="crediantials-field">Password:<span id="paassword_field">12345678</span><a
                                        href="javascript:void(0)" onclick="copyToClipboard('12345678')"><i class="fa fa-copy"></i></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
